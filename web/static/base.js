...
var HESTIA_I18N = {
    en: {
        ...
        'affiliate_protip': 'Pro tip: use a comparison website and then come back to use the links below',
        'affiliate_footnote': 'More partnerships will be added in the next few days!',
        'restore_btn': 'Restore',
        'save_btn': 'Save',
        ...
        'sqm_legend': 'Square meters',
        'sqm_info': "Only show homes with at least this many square meters (when available). Homes with unknown size will still be shown so you don't miss results.",
        'sqm_min_label': 'Minimum',
        'sqm_suffix': 'm2',
        ...
        'faq_a_speed': "Hestia checks most websites every few minutes, and some users have reported Hestia is faster than paid services!<br><br>I can't verify that, but I suspect some paid services aren't 100% honest about their speed because they assume people choose the service that claims to be fastest.<br><br>I don't have any incentive to be dishonest about that because Hestia is free!",
        ...
        'experimental_warning': 'Hestia is still a work in progress, so you may experience some instability here and there!',
        'landing_page_title': 'Hestia: free rental-home alerts for the Netherlands',
    ...
    nl: {
        ...
        'affiliate_protip': 'Pro tip: check een vergelijker en kom daarna terug om de links hier te gebruiken',
        'affiliate_footnote': 'Er komen meer samenwerkingen bij in de komende dagen!',
        'restore_btn': 'Herstel',
        'save_btn': 'Opslaan',
        ...
        'sqm_legend': 'Vierkante meters',
        'sqm_info': 'Toon alleen woningen met minimaal dit aantal vierkante meters (wanneer beschikbaar). Woningen met onbekende grootte worden nog steeds getoond zodat je niets mist.',
        'sqm_min_label': 'Minimum',
        'sqm_suffix': 'm2',
        ...
        'experimental_warning': 'Hestia is nog volop in ontwikkeling, dus het kan zijn dat er soms iets stuk gaat!',
        'landing_page_title': 'Hestia: gratis meldingen voor huurwoningen in Nederland',
